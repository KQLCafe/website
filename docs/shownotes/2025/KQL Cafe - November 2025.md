...
The [IdentityAccountInfo](https://learn.microsoft.com/en-us/defender-xdr/advanced-hunting-identityaccountinfo-table) table in the advanced hunting schema contains information about account information from various sources, including Microsoft Entra ID. This table also includes information and link to the identity that owns the account. Use this reference to construct queries that return information from this table.

Some notable attributes

- CriticalityLevel - The criticality score of the account
- DefenderRiskLevel - The risk level of the account as calculated by Microsoft Defender
- EnrolledMfas - Types of multifactor authentication methods configured for the account user and their status
- GroupMembership - Group identifiers assigned to the account
- AssignedRoles - Role identifiers assigned to the account
- EligibleRoles - Identifiers for roles the account are eligible to use (for example, Microsoft Entra Privileged Identity Management roles)

### Custom Data Collection

[Custom data collection Preview](https://learn.microsoft.com/en-us/defender-endpoint/custom-data-collection) enables organizations to expand and customize telemetry collection beyond default configurations to support specialized threat hunting and security monitoring needs. This feature allows security teams to define specific collection rules with tailored filters for event properties such as folder paths, process names, and network connections.
...
coalesce() returns the first non-null value from a list of expressions, evaluated from left to right.

- [coalesce](https://learn.microsoft.com/en-us/kusto/query/coalesce-function?view=microsoft-fabric)

```kql
DeviceEvents
| project InitiatingProcessAccountUpn, InitiatingProcessAccountName
| extend Identity = coalesce(InitiatingProcessAccountUpn,InitiatingProcessAccountName, "Unknown")
```

## What did you do with KQL this month?

### Azure Monitoring Extension – Version control
...
- [Source](https://github.com/alexverboon/Hunting-Queries-Detection-Rules/blob/main/Defender%20For%20Identity/MDI-Automatic%20Windows%20auditing%20configuration.md)
